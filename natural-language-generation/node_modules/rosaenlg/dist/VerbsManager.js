...
class VerbsManager {
    ...
    getConjugationDe(verb, tense, number, conjParams) {
        ...
        if (tensesWithParts.indexOf(tense) > -1) {
            ...
            const conjElts = german_verbs_1.getConjugation(this.embeddedVerbs || german_verbs_dict_1.default, verb, tense, 3, number, aux, pronominal, pronominalCase);
            this.verbParts.push(conjElts.slice(1).join('¤')); // FUTUR2: 'wird gedacht haben'
            return conjElts[0];
        }
        else {
            return german_verbs_1.getConjugation(this.embeddedVerbs || german_verbs_dict_1.default, verb, tense, 3, number, null, pronominal, pronominalCase).join('¤');
        }
    }
