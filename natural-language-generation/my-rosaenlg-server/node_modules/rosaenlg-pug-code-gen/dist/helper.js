    ...
    getVerbCandidatesData() {
        ...
        this.verbCandidates.forEach(function (verbCandidate) {
            switch (language) {
                ...
                case 'fr_FR': {
                    try {
                        res[verbCandidate] = frenchVerbs.getVerbInfo(french_verbs_lefff_1.default, verbCandidate); //NOSONAR
                    }
                    catch (e) {
                ...
                case 'de_DE': {
                    try {
                        res[verbCandidate] = germanVerbs.getVerbInfo(german_verbs_dict_1.default, verbCandidate); //NOSONAR
                    }
                    catch (e) {
                ...
                case 'it_IT': {
                    try {
                        res[verbCandidate] = italianVerbs.getVerbInfo(italian_verbs_dict_1.default, verbCandidate); //NOSONAR
                    }
                    catch (e) {
    ...
    getWordCandidatesData() {
        ...
        this.wordCandidates.forEach(function (wordCandidate) {
            switch (language) {
                ...
                case 'fr_FR': {
                    try {
                        res[wordCandidate] = frenchWordsGender.getGenderFrenchWord(french_words_gender_lefff_1.default, //NOSONAR
                        wordCandidate);
                    }
                    catch (e) {
                ...
                case 'de_DE': {
                    try {
                        res[wordCandidate] = germanWords.getWordInfo(german_words_dict_1.default, wordCandidate); //NOSONAR
                    }
                    catch (e) {
                ...
                case 'it_IT': {
                    try {
                        res[wordCandidate] = italianWords.getWordInfo(italian_words_dict_1.default, wordCandidate); //NOSONAR
                    }
                    catch (e) {
    ...
    getAdjectiveCandidatesData() {
        ...
        this.adjectiveCandidates.forEach(function (adjectiveCandidate) {
            switch (language) {
                case 'de_DE': {
                    try {
                        const adjData = germanAdjectives.getAdjectiveInfo(german_adjectives_dict_1.default, //NOSONAR
                        adjectiveCandidate);
                ...
                case 'it_IT': {
                    try {
                        const adjData = italianAdjectives.getAdjectiveInfo(italian_adjectives_dict_1.default, //NOSONAR
                        adjectiveCandidate);
                        res[adjectiveCandidate] = adjData;
                    }
                    catch (e) /* istanbul ignore next */ {
