...
function getBeforeNoun(adj, noun) {
    if (adjChangeants[adj]) {
        const nounStartsVowel = 'aeiouyàáâãäåèéêëìíîïòóôõöøùúûüÿAEIOUYÀÁÂÃÄÅÈÉÊËÌÍÎÏÒÓÔÕÖØÙÚÛÜŸ'.indexOf(noun.charAt(0)) > -1;
        const nounIsHMuet = noun.charAt(0).toLowerCase() === 'h' && french_h_muet_aspire_1.isHMuet(noun);
...
function agree(adjective, gender, number, noun, isBeforeNoun) {
