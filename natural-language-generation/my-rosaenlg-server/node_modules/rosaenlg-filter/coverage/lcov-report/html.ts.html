...
<head>
    <title>Code coverage report for html.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> html.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">436x</span>
<span class="cline-any cline-yes">1308x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">436x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export interface ReplacedHtml {
  replaced: string;
  elts: string[];
}
&nbsp;
