...
<head>
    <title>Code coverage report for clean.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> clean.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">438x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export function joinLines(input: string /*, lang: string*/): string {
