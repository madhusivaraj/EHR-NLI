...
const italian_1 = require("rosaenlg-filter/dist/italian");
...
function getIrregularBeforeNoun(adjective, gender, number, noun) {
    ...
    switch (adjective.toLowerCase()) {
        case 'bello': {
            if (gender === 'M') {
                if (italian_1.startsWithVowel(noun)) {
                    if (number === 'S') {
                        return "bell'";
                    }
                    else {
                ...
                else if (italian_1.isConsonneImpure(noun) || italian_1.isIFollowedByVowel(noun)) {
                    if (number === 'S') {
                        return 'bello';
                    }
                    else {
        ...
        case 'buono': {
            if (gender === 'M') {
                if (italian_1.isConsonneImpure(noun) || italian_1.isIFollowedByVowel(noun)) {
                    if (number === 'S') {
                        return 'buono';
                    }
                    else {
        ...
        case 'grande': {
            if (number === 'P') {
                ...
                else if (italian_1.startsWithVowel(noun)) {
...
function agreeItalianAdjective(adjList, adjective, gender, number, noun, isBeforeNoun) {
